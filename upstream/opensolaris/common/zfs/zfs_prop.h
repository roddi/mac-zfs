...
extern "C" {
	...
	int	zfs_prop_valid_for_type(zfs_prop_t prop, int types);
	boolean_t zfs_prop_is_visible(zfs_prop_t prop);
	zfs_prop_t zfs_prop_iter_common(zfs_prop_f func, void *cb, zfs_type_t type, boolean_t show_all, boolean_t ordered);
	zfs_prop_t zfs_name_to_prop_cb(zfs_prop_t prop, void *cb_data);
	zfs_prop_t zfs_name_to_prop_common(const char *propname, zfs_type_t type);
	const char *zpool_prop_default_string(zpool_prop_t prop);
